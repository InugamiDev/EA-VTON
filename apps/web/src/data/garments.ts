...
export const GARMENTS: Garment[] = [
  {
    ...
    brand: "UNIQLO",
    description:
      "Made from 100% SUPIMA cotton with long fibers that create a fine, smooth fabric surface. Clean appearance and consistent coloring compared to standard cotton.",
    price: 19.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Premium Supima cotton tee in black. Exceptionally soft with a clean crew neckline and relaxed fit for any occasion.",
    price: 19.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Comfortable AIRism fabric with the look of cotton. Accented by an overlapping V-neck design with meticulous stitching details.",
    price: 14.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Finely woven premium Oxford fabric with a crisp, supple texture. Button-down collar and slim fit for a sleek look.",
    price: 29.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Relaxed boxy silhouette in soft denim with a half-sleeve cut. Casual enough for weekends, polished enough for the office.",
    price: 39.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Classic pullover hoodie in a comfortable sweat fabric. Kangaroo pocket and adjustable drawstring hood for everyday wear.",
    price: 39.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Relaxed oversized silhouette with dropped shoulders. Heavyweight sweat fabric for a premium feel and structure.",
    price: 49.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Ultra-light parka with UV protection that folds into its own pocket. Water-repellent finish keeps you dry in light rain.",
    price: 49.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Windproof outer layer with DWR water-repellent finish. Lightweight layering piece with adjustable hood and cuffs.",
    price: 49.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Knitted polo in smooth cotton with a refined sheen. Ribbed collar and placket for a smart-casual look that transitions from office to evening.",
    price: 49.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Machine-washable knitted polo with a skipper collar. Easy-care blend that keeps its shape wash after wash.",
    price: 39.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Extra fine merino wool for a smooth, luxurious feel. Lightweight enough for layering yet warm enough on its own.",
    price: 39.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Lightweight puffer vest with PUFFTECH insulation. Machine washable, packable, and warm enough for transitional weather.",
    price: 29.90,
  ...
  },
  {
    ...
    brand: "UNIQLO",
    description:
      "Oversized zip-up hoodie with a heavyweight fabric for structure. Two-way zipper and side pockets for versatile layering.",
    price: 59.90,
